...
def fused_timing_features(natal,transits=None,progressions=None,solar_arcs=None,returns=None):
    return {'transits':[e.__dict__ for e in aspect_hits(transits or [],natal)],'progressions':secondary_progression_features(progressions or [],natal),'solar_arcs':solar_arc_features(solar_arcs or [],natal),'returns':return_features(returns or [],natal)}
